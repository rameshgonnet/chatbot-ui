...
AS $$
DECLARE
  project_url TEXT := 'https://ohizisgavpjvqpehyjdk.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9oaXppc2dhdnBqdnFwZWh5amRrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NTg5Nzg4OSwiZXhwIjoyMDYxNDczODg5fQ.4duKHtuJUbWjrPNMV2B0dbt1_ze68ujePZUXpi2zl2E'; -- full access needed for http request to storage
